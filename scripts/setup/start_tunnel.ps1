...
try {
    $null = Invoke-RestMethod -Uri "http://localhost:5001/health" -TimeoutSec 3
    Write-Host "      ✅ Widget API is running on port 5001" -ForegroundColor Green
} catch {
...
Write-Host " ========================================"
Write-Host ""
Write-Host "   Starting tunnel to localhost:5001..."
